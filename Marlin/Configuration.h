...
#define CUSTOM_MACHINE_NAME "Potus 3D"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 12.32
  #define DEFAULT_bedKi 1.23
  #define DEFAULT_bedKd 82.1
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 60, 60, 3, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 42, 0, -1.76 }
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC (141.1*2)
  #define XY_DIAG_BD (141.4*2)
